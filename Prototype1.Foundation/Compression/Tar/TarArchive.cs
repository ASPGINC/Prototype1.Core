...
namespace Prototype1.Foundation.Compression.Tar
{
	/// <summary>
	...
	public class TarArchive : IDisposable
	{
		...
		/// </param>
        public List<string> ExtractContents(string destinationDirectory)
		{
			...
			while (true) {
			    ...
			    var file = ExtractEntry(destinationDirectory, entry);
		...
		/// </param>
		string ExtractEntry(string destDir, TarEntry entry)
		{
			OnProgressMessageEvent(entry, null);
