...
using Prototype1.Foundation.Compression.Encryption;
#endif

using Prototype1.Foundation.Compression.Core;
using Prototype1.Foundation.Compression.Checksums;
using Prototype1.Foundation.Compression.Zip.Compression.Streams;
using Prototype1.Foundation.Compression.Zip.Compression;

namespace Prototype1.Foundation.Compression.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using Prototype1.Foundation.Compression.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Prototype1.Foundation.Compression.Zip.ZipException">
