...
namespace Prototype1.Foundation.Compression.Zip.Compression.Streams 
{
	...
	/// as the <see cref="Prototype1.Foundation.Compression.GZip.GZipInputStream">GZipInputStream</see>.
	///
